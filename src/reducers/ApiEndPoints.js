...
export const EVALUATION_BUNDLE_ENABLE_DISABLE_PRINTOUT = BASE_URL + "/evaluation-bundle/v1/enable-disable-printout-for-evaluation-bundles"
...
export const SAVE_VISITOR = BASE_URL + "/visitor/save-visitor"